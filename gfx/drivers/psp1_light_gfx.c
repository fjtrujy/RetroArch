...
static INLINE void psp_light_set_screen_coords (psp1_light_sprite_t* framecoords,
...
static INLINE void psp_light_set_tex_coords (psp1_light_sprite_t* framecoords,
...
static void psp_light_update_viewport(psp1_light_video_t* psp,
      video_frame_info_t *video_info);

static void psp_light_on_vblank(u32 sub, psp1_light_video_t *psp)
{
   if (psp)
      ...
      input_driver_t **input, void **input_data)
{
   ...
   psp->frame_coords        = memalign(64,
         (((PSP_FRAME_SLICE_COUNT * sizeof(psp1_light_sprite_t)) + 63) & ~63));
   psp->menu.frame_coords   = memalign(64,
         (((PSP_FRAME_SLICE_COUNT * sizeof(psp1_light_sprite_t)) + 63) & ~63));

   memset(psp->frame_coords, 0,
         PSP_FRAME_SLICE_COUNT * sizeof(psp1_light_sprite_t));
   ...
   sceKernelRegisterSubIntrHandler(PSP_VBLANK_INT, 0, psp_light_on_vblank, psp);
      ...
      unsigned pitch, const char *msg, video_frame_info_t *video_info)
{
   ...
   if (psp->should_resize)
      psp_light_update_viewport(psp, video_info);

   psp_light_set_tex_coords(psp->frame_coords, width, height);
                               ...
                               unsigned width, unsigned height, float alpha)
{
   ...
   psp_light_set_screen_coords(psp->menu.frame_coords, 0, 0,
         SCEGU_SCR_WIDTH, SCEGU_SCR_HEIGHT, 0);
   psp_light_set_tex_coords(psp->menu.frame_coords, width, height);
      ...
      video_frame_info_t *video_info)
{
   ...
   psp_light_set_screen_coords(psp->frame_coords, psp->vp.x,
